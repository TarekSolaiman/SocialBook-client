  ...
  return (
    <section>
      <div className="flex flex-col p-6 mx-10 my-10 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
        ...
        <div>
          <img
            src={postPhoto}
            alt=""
            className="object-cover w-full lg:w-3/4 mx-auto rounded-lg mb-4 sm:h-96 dark:bg-gray-500"
          />
          <p className="text-sm dark:text-gray-400">{postText}</p>
        </div>
      ...
      <div className="mx-10">
        ...
        {comment?.map((com) => (
          <Allcomment key={com._id} com={com} />
        ))}
      </div>
    </section>
  );
