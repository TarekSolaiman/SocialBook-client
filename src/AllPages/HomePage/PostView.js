...
const PostView = ({ post }) => {
  ...
  return (
    <div className="flex flex-col p-6 my-10 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-900 text-gray-100">
      ...
      <div>
        <img
          src={postPhoto}
          alt=""
          className="object-cover w-full lg:w-3/4 mx-auto rounded-lg mb-4 sm:h-96 bg-gray-500"
        />
        <p className="text-sm text-gray-400">{postText}</p>
      </div>
